                                    ...
                                    <div class="card-body">
                                        <div class="row mb-3">
                                            ...
                                            <div class="col-md-6">
                                                ...
                                                <input type="text" id="prenom_client" name="designation" class="form-control" value="{{$devis->designation}}" readonly>
                                            </div>
                                        </div>
                                        <div class="row mb-3">
                                            <div class="col-md-6" style="display: none;">
                                ...
                                <div class="card">
                                    <div class="card-body">
                                        <div class="row mb-3">
                                            ...
                                            <div class="col-md-6">
                                                <label for="prenom_client" class="form-label">Designation du colis</label>
                                                <input type="text" id="prenom_client" name="designation" class="form-control" value="{{$devis->designation}}" readonly>
                                            </div>
                                        </div>
                                        <div class="row mb-3">
