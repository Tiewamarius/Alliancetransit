    ...
    <table class="table table-bordered">
        ...
        <tbody>
            @foreach ($devisClients as $devis)
                <tr>
                    <td>
                        <a href="editDevis/{{ $devis->id }}" class="btn btn-outline-danger" style="color: orangered; width: 40px; padding:5px;">
                    ...
                    <td>
                        <a href="{{ route('deleteDevis.delete', $devis->id) }}" class="btn btn-outline-danger" onclick="return confirm('Êtes-vous sûr de vouloir supprimer cette expédition ?')">
